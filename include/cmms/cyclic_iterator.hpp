#ifndef COMMONS_INCLUDE_CMMS_CYCLIC_ITERATOR_HPP_
#define COMMONS_INCLUDE_CMMS_CYCLIC_ITERATOR_HPP_
...
auto make_cycle(T& t)
{
    return CyclicIterator(std::begin(t), std::end(t));
}

} // namespace cmms

#endif // COMMONS_INCLUDE_CMMS_CYCLIC_ITERATOR_HPP_